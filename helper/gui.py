...
class TicTacToeGUI():
    ...
    def setup_ui(self):
        ...
        self.btn1=tk.Button(buttonframe, command=lambda: self.click_cell(1,self.currPlayer.mark))
        self.btn1.grid(row=0,column=0,sticky=tk.N+tk.S+tk.E+tk.W) # sticky extends the buttons to the edge of the window.
        self.btn2=tk.Button(buttonframe, command=lambda: self.click_cell(2,self.currPlayer.mark))
        self.btn2.grid(row=0,column=1,sticky=tk.N+tk.S+tk.E+tk.W)
        self.btn3=tk.Button(buttonframe, command=lambda: self.click_cell(3,self.currPlayer.mark))
        self.btn3.grid(row=0,column=2,sticky=tk.N+tk.S+tk.E+tk.W)
        self.btn4=tk.Button(buttonframe, command=lambda: self.click_cell(4,self.currPlayer.mark))
        self.btn4.grid(row=1,column=0,sticky=tk.N+tk.S+tk.E+tk.W) 
        self.btn5=tk.Button(buttonframe, command=lambda: self.click_cell(5,self.currPlayer.mark))
        self.btn5.grid(row=1,column=1,sticky=tk.N+tk.S+tk.E+tk.W)
        self.btn6=tk.Button(buttonframe, command=lambda: self.click_cell(6,self.currPlayer.mark))
        self.btn6.grid(row=1,column=2,sticky=tk.N+tk.S+tk.E+tk.W)
        self.btn7=tk.Button(buttonframe, command=lambda: self.click_cell(7,self.currPlayer.mark))
        self.btn7.grid(row=2,column=0,sticky=tk.N+tk.S+tk.E+tk.W) 
        self.btn8=tk.Button(buttonframe, command=lambda: self.click_cell(8,self.currPlayer.mark))
        self.btn8.grid(row=2,column=1,sticky=tk.N+tk.S+tk.E+tk.W)
        self.btn9=tk.Button(buttonframe, command=lambda: self.click_cell(9,self.currPlayer.mark))
        self.btn9.grid(row=2,column=2,sticky=tk.N+tk.S+tk.E+tk.W)
